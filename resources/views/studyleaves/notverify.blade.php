                    ...
                    <style>
                        ...
                        <div class="content-wrapper">
                            <div  class="flex-grow-1 container-p-y container">
                                <h1 style="color: red">FAKE</h1>
                                <hr/>
                                <div class="card">
                                    <div class="card-header" style="background-color: red; color: white">
                                        <div class="md-6">
                                            <p>This Study Leave Letter is <b>FAKE</b> NOT FROM  REGIONAL EDUCATION DIRECTORATE (E)</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body" style="color: red">
                                        ...
                                        <br>
                                        <h1 style="">FAKE STUDY LEAVE LETTER</h1>
                                        <br>
                                        <p>Please report the case to the Regional Education Directorate</p>
                                    </div>
